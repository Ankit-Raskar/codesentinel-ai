...
-- REVIEW COMMENTS (individual issues)
CREATE TABLE public.review_comments (
  ...
  line_number INTEGER,
  severity TEXT NOT NULL DEFAULT 'suggestion', -- critical|warning|suggestion|optimization
  category TEXT, -- bug|security|performance|smell|style
  title TEXT NOT NULL,
